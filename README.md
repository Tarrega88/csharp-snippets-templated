...
It's a slightly different approach to the larger csharp-snippets repo. This one doesn't offer types in the snippet shortcut, but instead just preselects the generic types to be filled in.
